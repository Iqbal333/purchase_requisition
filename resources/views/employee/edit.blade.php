        ...
        <div class="card">
            <div class="card-header">Create Employee
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('employee.edit') }}">Employee</a>
                </span>
            </div>
            <div class="card-body">
                {!! Form::open(array('route' => 'employee.update', 'method'=>'POST')) !!}
                @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <strong>NIK:</strong>
                                <input type="text" name="nik" value="{{ $product->nik }}" placeholder="NIK" class="form-control">
                            </div>
                        </div>
                    </div>
